          ...
          <Container as="div" className={"infoContainer"}>
            ...
            <Container as={"div"}>
              ...
              <p className="landingPageInfoText">
                ...
                pop-prosjektet Erica. Helgene går ofte med til å spille
                konserter med disse, noe jeg synes er skikkelig stas. Ellers er
                jeg glad i å holde meg aktiv, og prøver å trene 6 ganger i uka.
                Jeg er glad i å spille videospill, og har den siste tida spilt
                mye OverWatch og Cyberpunk2077.
              </p>
            </Container>
          </Container>
          <Container as="div" className={"infoContainer"}>
            <Container as={"div"}>
              ...
              <p className="landingPageInfoText">
                ...
                laget i forbindelse med studie, men det er og noen egne
                prosjekter her. Prosjektene er merket med et merke for å vise om
                de er laget i forbindelse med studie eller om det er egne
                prosjekter.
              </p>
            </Container>
            <Image
